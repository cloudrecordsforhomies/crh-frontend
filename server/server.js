...
// ============== Database ============== //
// if mysql goes down mysql.server restart
  ...
  db.query(sql, function(err, result, fields){
    ...
    db.query(sql2, function(err, result2, fields){
      ...
      var mailOptions = {
        ...
        html: `Booking has been confirmed. Renter:${result[0].first} ${result[0].last} phone:${result[0].phone}. Host:${result2[0].first} ${result2[0].last} phone:${result2[0].phone} `
    };
...
app.post('/users/new', (req, res) => {
  ...
  var mailOptions = {
    ...
    text: `Hey there, ${req.body.first}! Welcome to Cache! We are excited to have you.`, // plaintext body
    html: `Hey there, ${req.body.first}! Welcome to Cache! We are excited to have you.`
};
