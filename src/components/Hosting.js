...
export default class Hosting extends Component {
  ...
  handleSubmit = event => {
    ...
    var b;
    var self = this;
    var b = axios.post("http://52.15.115.174:5000/booking/new", {hostId:this.state.user, checkIn:checkIn, checkOut:checkOut, address:this.state.location, picture:img, squareFeet: this.state.squareFootage, latitude:this.state.latitude, longitude:this.state.longitude, price:this.state.price})
