...
export default class Signup extends Component {
  ...
  handleSubmit = async event => {
    ...
    var self = this;
    axios.post('http://cache370.com:5000/users/new', {first: self.state.first, last: self.state.last,email: self.state.email,password: self.state.password, phone: self.state.phone, profPic: self.state.image, file:self.state.file})
    .then(function(){
      axios.post(`http://cache370.com:5000/users/login`, {email:self.state.email, password:self.state.password
    })
